...
export default function DocsIntroPage() {
  return (
    <div className="space-y-8">
      <div>
        <h1 id="welcome-to-basecamp" className="text-3xl font-bold">
          Welcome to BaseCamp
        </h1>
      ...
      <section>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="p-6 border rounded-lg bg-card">
            <h3 id="components" className="font-semibold mb-3 text-lg">
              Components
            </h3>
          ...
          <div className="p-6 border rounded-lg bg-card">
            <h3 id="primitives" className="font-semibold mb-3 text-lg">
              Primitives
            </h3>
            <p className="text-sm text-muted-foreground mb-4">
      ...
      <section>
        <h2 id="quick-example" className="text-2xl font-semibold mb-4">
          Quick Example
        </h2>
      ...
      <section>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="p-4 border rounded-lg">
            <h3 id="typescript" className="font-semibold mb-2">
              TypeScript
            </h3>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="p-4 border rounded-lg">
            <h3 id="tailwind-css" className="font-semibold mb-2">
              Tailwind CSS
            </h3>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="p-4 border rounded-lg">
            <h3 id="accessible" className="font-semibold mb-2">
              Accessible
            </h3>
            <p className="text-sm text-muted-foreground">
      ...
      <section>
        <h2 id="whats-next" className="text-2xl font-semibold mb-4">
          What&apos;s Next?
        </h2>
