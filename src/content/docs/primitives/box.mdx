---
title: Box
description: A flexible container component that can render as any HTML element. This is a foundational primitive that provides a consistent way to create containers with custom styling.
